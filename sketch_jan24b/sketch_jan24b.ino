...
unsigned char front[] = {0x00,0x00,0x00,0x00,0x00,0x24,0x48,0x90,0x48,0x24,0x00,0x00,0x00,0x00,0x00,0x00};
unsigned char right[] = {0x00,0x00,0x00,0x00,0x00,0x00,0x44,0x28,0x10,0x44,0x28,0x10,0x44,0x28,0x10,0x00};
unsigned char left[] = {0x00,0x10,0x28,0x44,0x10,0x28,0x44,0x10,0x28,0x44,0x00,0x00,0x00,0x00,0x00,0x00};
unsigned char STOP01[] = {0x2E,0x2A,0x3A,0x00,0x02,0x3E,0x02,0x00,0x3E,0x22,0x3E,0x00,0x3E,0x0A,0x0E,0x00};
unsigned char clear[] = {0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00};
unsigned char knapp1[] = {0x7e, 0x10, 0x7e, 0x00, 0x7e, 0x4a, 0x00, 0x7e, 0x40, 0x00, 0x7e, 0x40, 0x00, 0x7e, 0x42, 0x7e};
unsigned char knapp2[] = {0x00, 0x00, 0x00, 0x08, 0x14, 0x22, 0x42, 0x84, 0x84, 0x42, 0x22, 0x14, 0x08, 0x00, 0x00, 0x00};
...
void loop()
  ...
  if (irrecv.decode(&results)) 
 {
    ...
    switch(irr_val)
    {
      ...
      case 0xFF6897 : car_hello(); matrix_display(knapp1); break;
      case 0xFF9867 : car_heart(); matrix_display(knapp2); break;
...
void car_hello()//car hello
{}

void car_heart()//car hjärta
{}
